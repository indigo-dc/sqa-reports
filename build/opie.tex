...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=65]{\textbf{\#3767} opie SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/opie-codestyle/24}{opie-codestyle}.
...
\includegraphics[scale=0.5]{/srv/sqa-reports/build/figs/graph_opie-unittest.png}
\\
%\vspace{0.5em}
...
\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/opie-unittest/22}{opie-unittest}.
