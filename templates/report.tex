...
\begin{tabular}{ll}
    ...
    \hyperref[sec:gitbook]{GitBook documentation} & \BLOCK{if product.config_management.status_notcomplete}\redbox{NOT COMPLETE}\BLOCK{elif product.gitbook.url}\greenbox{COMPLETE}\BLOCK{else}\redbox{NOT COMPLETE}\BLOCK{endif} \\
