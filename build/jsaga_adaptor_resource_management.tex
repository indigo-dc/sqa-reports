...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE}\\[0.5em]\redbox{\strut \begin{huge}20\% done\end{huge}} 
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=20]{\textbf{\#4016} jSAGA RM API SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=0,
            name=WBS1A
