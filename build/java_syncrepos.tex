...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=83]{\textbf{\#3065} java-syncrepos SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/syncrepos-codestyle/46}{syncrepos-codestyle}.
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=44.444443]{Methods (48.0/108.0)}{1}{3} \\
            \ganttbar[progress=34.564255]{Lines (234.0/677.0)}{1}{3} \\
            \ganttbar[progress=28.695652]{Conditionals (66.0/230.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}

\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/syncrepos-unittest/44}{syncrepos-unittest}.
...
\begin{tabular}{ll}
    ...
    Manifest link & \url{https://github.com/indigo-dc/java-syncrepos/tree/master/ansible} \\
\end{tabular}
\end{center}
