...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=77]{\textbf{\#3530} indigo-kepler SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\subsection{Observations}
\begin{itemize}
        \item PT claims functional tests are run. We expect description and report with successful results.
    \end{itemize}
