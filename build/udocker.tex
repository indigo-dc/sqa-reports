...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\greenbox{\strut COMPLETE}\\[0.5em]\greenbox{\strut \begin{huge}72\% done\end{huge}} 
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=72]{\textbf{\#3641} udocker SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\includegraphics[scale=0.5]{/srv/sqa-reports/build/figs/graph_udocker-unittest.png}
\\
%\vspace{0.5em}
...
\subsection{Observations}
\begin{itemize}
        \item Ansible playbook provided by the product team. Work in progress by WP3; setting progress to 50\%.
    \end{itemize}
