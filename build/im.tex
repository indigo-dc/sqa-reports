...
\href{https://jenkins.indigo-datacloud.eu:8080//job/im-codestyle/95}{im-codestyle}.
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=65.82135]{Lines (6956.0/10568.0)}{1}{3} \\
...
\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/im-unittest/92}{im-unittest}.
