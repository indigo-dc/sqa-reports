...
\title{Software Quality Assurance (SQA) Report \\[0.7em] \large{27 Jun - 01 July 2016}\\[1.5em] 
       \huge{\texttt{JSAGA FG Adaptors (JSAGA FutureGateway Adaptors (TOSCA, rOCCI))}}\\
}
...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE}\\[0.5em]\redbox{\strut \begin{huge}33\% done\end{huge}} 
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=33]{\textbf{\#3473} JSAGA FG Adaptors SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#3476} Repository synchronization}{1}{12} \\
            \ganttbar[
            progress=0,
            name=WBS1A
        ]{\textbf{\#3479} Code style specification}{1}{12} \\
            \ganttbar[
            progress=0,
            name=WBS1A
        ]{\textbf{\#3482} Unit testing coverage}{1}{12} \\
            \ganttbar[
            progress=0,
            name=WBS1A
        ]{\textbf{\#3485} Functional and integration testing coverage}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#3488} Configuration management}{1}{12} \\
            \ganttbar[
            progress=0,
            name=WBS1A
        ]{\textbf{\#3491} GitBook documentation}{1}{12} \\
     [grid]
\end{ganttchart}
