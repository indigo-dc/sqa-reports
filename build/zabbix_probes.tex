...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=48]{\textbf{\#3221} Zabbix Probes SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\begin{itemize}
        \item Progress set to 50\% since the product is adhered to a standard, but not currently compliant with it.
    \end{itemize}
