...
\title{Software Quality Assurance (SQA) Report \\[0.7em] \large{11 - 15 July 2016}\\[1.5em] 
       \huge{\texttt{FutureGateway API Server}}\\
}
...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE}\\[0.5em]\redbox{\strut \begin{huge}67\% done\end{huge}} 
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=67]{\textbf{\#3809} FutureGateway API Server SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
Repository exists under \texttt{indigo-dc} GitHub organization:
    \begin{itemize}
        ...
        \item \url{https://github.com/indigo-dc/fgTools}\
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/fgapiserverdaemon-codestyle/1}{fgapiserverdaemon-codestyle}.
\href{https://jenkins.indigo-datacloud.eu:8080//job/fgtools-codestyle/1}{fgtools-codestyle}.
\href{https://jenkins.indigo-datacloud.eu:8080//job/fgapiserver-codestyle/3}{fgapiserver-codestyle}.

\subsection{Observations}
\begin{itemize}
        \item Team has proposed a code style standard and the first job (fgapiserver-codestyle) is successful.
    \end{itemize}
...
\subsection{Observations}
\begin{itemize}
        \item Jenkins job is still to be defined at INDIGO Jenkins CI.
    \end{itemize}
...
\subsection{Observations}
\begin{itemize}
        \item Team has provided reports of some integration tests.
        \item Automated functionality testing has not been provided.
    \end{itemize}
...
\begin{center}
\graybox{\strut Instalaltion, Usage}
\end{center}
