...
\begin{tabular}{ll}
    ...
    \hyperref[sec:unit_test]{Code coverage} & \graybox{89\%}\\ 
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=90]{\textbf{\#3086} CLUES SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/clues-codestyle/8}{clues-codestyle}.
...
\begin{enumerate}
        \item Deploy a (galaxy elastic or mesos) cluster by providing a TOSCA file to the orchestrator.
        \item Add/delete cluster nodes.
        \item Monitor job scheduling.
    \end{enumerate}

\subsection{Reports}
Functional report/s available:
\begin{itemize}
        \item \href{https://owncloud.indigo-datacloud.eu/index.php/apps/files/?dir=%2FINDIGO-DC%20testing%20reports%2Fintegration%2Findigo_1%2FCLUES}{owncloud report}
    \end{itemize}
...
\begin{itemize}
        \item Points to improve in the documentation: \begin{itemize} \item Align documentation sections to the ones defined in [1], in case you need to add different sections, do it at the end. \item README: is incomplete (see [2]); please indicate: \begin{itemize} \item what is the role of CLUES within INDIGO \item component/s with which it interacts \item where it should be deployed (site level, infrastructure centrally) \item ... \end{itemize} \item Deployment/User/Developer guide: make them available (links to external sources could be added) \begin{itemize} \item Product will be available as a tarball at INDIGO repository, please address the deployment using this tarball. \end{itemize} \end{itemize}
    \end{itemize}
...
\subsection{Observations}
\begin{itemize}
        \item Jenkins jobs will be created at INDIGO-DataCloud CI.
    \end{itemize}
