...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=67]{\textbf{\#3221} Zabbix Probes SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/zabbix-probes-codestyle/1}{zabbix-probes-codestyle}.
