...
\href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-codestyle/68}{orchestrator-codestyle}.
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=37.163376]{Lines (1242.0/3342.0)}{1}{3} \\
            \ganttbar[progress=21.564482]{Conditionals (204.0/946.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}

\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-unittest/62}{orchestrator-unittest}.
