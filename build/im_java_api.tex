...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\greenbox{\strut COMPLETE}\\[0.5em]\greenbox{\strut \begin{huge}98\% done\end{huge}} 
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=98]{\textbf{\#2981} im-java-api SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
Repository exists under \texttt{indigo-dc} GitHub organization:
    \begin{itemize}
        \item \url{https://github.com/indigo-dc/im-java-api}\
        \end{itemize}
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/im-java-api-codestyle/26}{im-java-api-codestyle}.
...
\includegraphics[scale=0.5]{/srv/sqa-reports/build/figs/graph_im-java-api-unittest.png}
\\
%\vspace{0.5em}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            \ganttbar[progress=100.0]{Packages (13.0/13.0)}{1}{3} \\
            \ganttbar[progress=97.14286]{Files (68.0/70.0)}{1}{3} \\
            \ganttbar[progress=97.22222]{Classes (70.0/72.0)}{1}{3} \\
            \ganttbar[progress=89.67972]{Methods (252.0/281.0)}{1}{3} \\
            \ganttbar[progress=91.87675]{Lines (656.0/714.0)}{1}{3} \\
            \ganttbar[progress=86.065575]{Conditionals (105.0/122.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}

\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/im-java-api-unittest/20}{im-java-api-unittest}.
...
\subsection{Build status}
Last build status on Jenkins CI
    \href{https://jenkins.indigo-datacloud.eu:8080//job/im-java-api-functional/8}{im-java-api-functional}.
