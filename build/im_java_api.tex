...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=90]{\textbf{\#2981} im-java-api SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\begin{itemize}
        \item Points to improve in the documentation: \begin{itemize} \item Deployment guide \begin{itemize} \item Explain installation from INDIGO repo (tarballs and/or packages if available) \item Link to the Auth file is broken \end{itemize} \end{itemize}
    \end{itemize}
