...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE}\\[0.5em]\redbox{\strut \begin{huge}75\% done\end{huge}} 
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=75]{\textbf{\#3452} Ophidia analytics workflow interfaces SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\subsection{Observations}
\begin{itemize}
        \item Product team will make scripts available (from their local CI service) and job was defined, successfuly run
    \end{itemize}
...
\subsection{Observations}
\begin{itemize}
        \item Product team made the scripts available (from their local CI service) and job was defined, successfuly   run.
    \end{itemize}
