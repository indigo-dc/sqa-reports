...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=57]{\textbf{\#3530} indigo-kepler SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\begin{itemize}
        ...
        \item Conditional coverage is the one at 39\%, setting the progress aligned with this value.
    \end{itemize}
