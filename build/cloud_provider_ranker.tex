...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE}\\[0.5em]\redbox{\strut \begin{huge}78\% done\end{huge}} 
\end{center}
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/cloudproviderranker-codestyle/13}{cloudproviderranker-codestyle}.

\subsection{Observations}
\begin{itemize}
        \item Progress is set to 50\%: code style is defined but the current code is not compliant with it.
    \end{itemize}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=63.533836]{Lines (338.0/532.0)}{1}{3} \\
            \ganttbar[progress=57.575756]{Conditionals (114.0/198.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}

\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/cloudproviderranker-unittest/15}{cloudproviderranker-unittest}.
...
\subsection{Build status}
Last build status on Jenkins CI
    \href{https://jenkins.indigo-datacloud.eu:8080//job/cloudproviderranker-functional/7}{cloudproviderranker-functional}.
    


\subsection{Observations}
\begin{itemize}
        \item Jenkins job creates the JAR file for testing the functionalities documented in \href{https://indigo-dc.gitbooks.io/cloud-provider-ranker/content/chapter1.html}{GitBook}.
        \item Will get the report from https://indigo-dc.gitbooks.io/cloud-provider-ranker/content/chapter1.html
    \end{itemize}
