...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\graybox{\strut IN PROGRESS}\\[0.5em]\graybox{\strut \begin{huge}98\% done\end{huge}} 
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=98]{\textbf{\#2867} tts SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/tts-codestyle/154}{tts-codestyle}.
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=73.84969]{Lines (963.0/1304.0)}{1}{3} \\
...
\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/tts-unittest/140}{tts-unittest}.
...
\begin{itemize}
        \item a functional test coverage of 70% is reached and all tests are passing locally and on jenkins build server
    \end{itemize}
...
\begin{center}
\graybox{\strut Readme, User and Admin, Developers Guide, TTSc doc, REST API}
\end{center}
\subsection{Observations}
\begin{itemize}
        \item Documentation is geting almost done! Setting progress to 90\%
    \end{itemize}
...
\begin{tabular}{ll}
    ...
    Manifest link & \url{https://github.com/indigo-dc/ansible-role-tts} \\
\end{tabular}
\end{center}
