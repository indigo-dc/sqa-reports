...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE}\\[0.5em]\redbox{\strut \begin{huge}77\% done\end{huge}} 
\end{center}
...
\begin{tabular}{ll}
    ...
    \hyperref[sec:unit_test]{Code coverage} & \graybox{9\%}\\ 
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=77]{\textbf{\#3788} Synergy Scheduler Manager SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
Repository exists under \texttt{indigo-dc} GitHub organization:
    \begin{itemize}
        \item \url{https://github.com/indigo-dc/synergy-scheduler-manager}\
        \end{itemize}
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/synergy-scheduler-codestyle/4}{synergy-scheduler-codestyle}.
...
\includegraphics[scale=0.5]{/srv/sqa-reports/build/figs/graph_synergy-scheduler-unittest.png}
\\
%\vspace{0.5em}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            \ganttbar[progress=66.666664]{Packages (2.0/3.0)}{1}{3} \\
            \ganttbar[progress=84.61539]{Files (11.0/13.0)}{1}{3} \\
            \ganttbar[progress=84.61539]{Classes (11.0/13.0)}{1}{3} \\
            \ganttbar[progress=35.70562]{Lines (883.0/2473.0)}{1}{3} \\
            \ganttbar[progress=8.544304]{Conditionals (54.0/632.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}

\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/synergy-scheduler-unittest/4}{synergy-scheduler-unittest}.
    
\subsection{Observations}
\begin{itemize}
        \item Percentage is 9\% because of the conditional coverage, but other methods have higher coverage rates.
    \end{itemize}
...
\begin{itemize}
        ...
        \item Functional tests are on its way.
    \end{itemize}
