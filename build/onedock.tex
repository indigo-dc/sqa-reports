...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=83]{\textbf{\#3026} ONEDock SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#3896} Repository synchronization}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#3899} Code style specification}{1}{12} \\
            \ganttbar[
            progress=50,
            name=WBS1A
        ]{\textbf{\#3029} Unit testing coverage}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#3032} Functional and integration testing coverage}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#3035} Configuration management}{1}{12} \\
            \ganttbar[
            progress=50,
            name=WBS1A
        ]{\textbf{\#3038} GitBook documentation}{1}{12} \\
     [grid]
\end{ganttchart}
...
Repository exists under \texttt{indigo-dc} GitHub organization:
    \begin{itemize}
        \item \url{https://github.com/indigo-dc/onedock}\
        \end{itemize}
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/onedock-codestyle/32}{onedock-codestyle}.
...
\begin{itemize}
        \item No Jenkins job have been defined yet (WP3 duty).
    \end{itemize}
...
\begin{itemize}
        ...
        \item A description of the tests and a link to the test pipeline were provided.
    \end{itemize}
...
\subsection{Observations}
\begin{itemize}
        \item Points to improve in the documentation: \begin{itemize} \item Please make the documentation in the wiki available in gitbook. \item Deployment guide: describe the installation using the packages from INDIGO repository. \end{itemize}
    \end{itemize}
...
\begin{tabular}{ll}
    ...
    Manifest link & \url{https://github.com/indigo-dc/onedock/tree/master/ansible} \\
\end{tabular}
\end{center}
