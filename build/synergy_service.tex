...
\begin{tabular}{ll}
    ...
    \hyperref[sec:unit_test]{Code coverage} & \graybox{13\%}\\ 
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=68]{\textbf{\#2996} Synergy Service SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#2999} Repository synchronization}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#3920} Code style specification}{1}{12} \\
            \ganttbar[
            progress=10,
            name=WBS1A
        ]{\textbf{\#3923} Unit testing coverage}{1}{12} \\
            \ganttbar[
            progress=90,
            name=WBS1A
        ]{\textbf{\#3926} Functional and integration testing coverage}{1}{12} \\
            \ganttbar[
            progress=40,
            name=WBS1A
        ]{\textbf{\#3002} Configuration management}{1}{12} \\
            \ganttbar[
            progress=70,
            name=WBS1A
        ]{\textbf{\#3005} GitBook documentation}{1}{12} \\
     [grid]
\end{ganttchart}
...
Repository exists under \texttt{indigo-dc} GitHub organization:
    \begin{itemize}
        \item \url{https://github.com/indigo-dc/synergy-service}\
        \end{itemize}
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/synergy-codestyle/6}{synergy-codestyle}.
...
\includegraphics[scale=0.5]{/srv/sqa-reports/build/figs/graph_synergy-unittest.png}
\\
%\vspace{0.5em}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            \ganttbar[progress=83.333336]{Packages (5.0/6.0)}{1}{3} \\
            \ganttbar[progress=58.82353]{Files (10.0/17.0)}{1}{3} \\
            \ganttbar[progress=58.82353]{Classes (10.0/17.0)}{1}{3} \\
            \ganttbar[progress=29.427608]{Lines (437.0/1485.0)}{1}{3} \\
            \ganttbar[progress=12.777778]{Conditionals (46.0/360.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}

\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/synergy-unittest/5}{synergy-unittest}.
...
\begin{itemize}
        \item Reports for integration tests have been provided. They have been executed locally at their own testbed.
        \item Functional tests have been also provided, but not currently checked in INDIGO Jenkins CI. A description (in the task) of functionalities being checked for the functional tests is missing (setting progress to 90\%).
    \end{itemize}
...
\subsection{Observations}
\begin{itemize}
        \item Puppet module created at https://github.com/indigo-dc/puppet-synergy, though not finished as the Synergy product is still changing a bit.
    \end{itemize}
