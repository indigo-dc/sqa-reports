...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE}\\[0.5em]\redbox{\strut \begin{huge}87\% done\end{huge}} 
\end{center}
...
\begin{tabular}{ll}
    ...
    \hyperref[sec:unit_test]{Code coverage} & \graybox{33\%}\\ 
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=87]{\textbf{\#2945} pOCCI SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#3935} Repository synchronization}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#2948} Code style specification}{1}{12} \\
            \ganttbar[
            progress=33,
            name=WBS1A
        ]{\textbf{\#2951} Unit testing coverage}{1}{12} \\
            \ganttbar[
            progress=90,
            name=WBS1A
        ]{\textbf{\#2954} Functional and integration testing coverage}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#2957} Configuration management}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#2960} GitBook documentation}{1}{12} \\
     [grid]
\end{ganttchart}
...
\includegraphics[scale=0.5]{/srv/sqa-reports/build/figs/graph_pocci-unittest.png}
\\
%\vspace{0.5em}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            \ganttbar[progress=93.75]{Packages (15.0/16.0)}{1}{3} \\
            \ganttbar[progress=92.42424]{Files (61.0/66.0)}{1}{3} \\
            \ganttbar[progress=92.42424]{Classes (61.0/66.0)}{1}{3} \\
            \ganttbar[progress=21.82532]{Lines (3336.0/15285.0)}{1}{3} \\
...
\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/pocci-unittest/8}{pocci-unittest}.
...
\begin{itemize}
        ...
        \item The requested description (in the task) of functionalities being checked in the provided tests was provided.
    \end{itemize}
