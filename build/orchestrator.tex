...
\href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-codestyle/69}{orchestrator-codestyle}.
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            \ganttbar[progress=92.59259]{Packages (25.0/27.0)}{1}{3} \\
            \ganttbar[progress=89.52381]{Files (94.0/105.0)}{1}{3} \\
            \ganttbar[progress=80.327866]{Classes (98.0/122.0)}{1}{3} \\
            \ganttbar[progress=55.016537]{Methods (499.0/907.0)}{1}{3} \\
            \ganttbar[progress=37.85971]{Lines (1263.0/3336.0)}{1}{3} \\
            \ganttbar[progress=22.462202]{Conditionals (208.0/926.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}

\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/orchestrator-unittest/68}{orchestrator-unittest}.
