...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=90]{\textbf{\#2843} ooi SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/ooi-codestyle/7}{ooi-codestyle}.
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            ...
            \ganttbar[progress=92.81989]{Lines (2314.0/2493.0)}{1}{3} \\
            \ganttbar[progress=87.275986]{Conditionals (487.0/558.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}

\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/ooi-unittest/9}{ooi-unittest}.
...
\subsection{Build status}
Last build status on Jenkins CI
    \href{https://jenkins.indigo-datacloud.eu:8080//job/ooi-functional/1}{ooi-functional}.
    
\subsection{Test coverage}
\begin{enumerate}
        \item Instance management: Creation (with and without contextualization, with and without SSH key injection), deletion, pausing, unpausing, listing, getting details of instances.
        \item Volume management: Creation, deletion of volumes and volume links.
        \item Network management: IP creation, removal, linking, etc.
        \item Listing, getting details of images.
        \item Listing, getting details of flavors.
    \end{enumerate}
