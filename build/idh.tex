...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=50]{\textbf{\#2876} idh SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/idh-codestyle/8}{idh-codestyle}.
...
\begin{itemize}
        \item The command provided by the product team for running the tests is currently failing.
    \end{itemize}
