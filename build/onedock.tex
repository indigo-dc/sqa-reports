...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\graybox{\strut IN PROGRESS}\\[0.5em]\graybox{\strut \begin{huge}92\% done\end{huge}} 
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=92]{\textbf{\#3026} ONEDock SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/onedock-codestyle/30}{onedock-codestyle}.
