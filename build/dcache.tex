...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\greenbox{\strut COMPLETE}\\[0.5em]\greenbox{\strut \begin{huge}82\% done\end{huge}} 
\end{center}
...
\begin{tabular}{ll}
    ...
    \hyperref[sec:unit_test]{Code coverage} & \graybox{22\%}\\ 
...
\subsection{Observations}
\begin{itemize}
        \item PT provided links to the reports for the code coverage and functional testing 
    \end{itemize}
...
\begin{enumerate}
        \item  gplazma (authentication)
        \item webdav (file transfer and REST interface handler)
    \end{enumerate}


\subsection{Observations}
\begin{itemize}
        \item Quoting PT: \textit{'We are in the process of switching to a different testing system (Robot framework), overarching tests of Indigo-specific functionality are still missing at the moment.'}
    \end{itemize}
...
\subsection{Observations}
\begin{itemize}
        \item Points to improve in the documentation: \begin{itemize} \item How to install this product using INDIGO repository (both for CentOS7 and Ubuntu 14.04 systems).\end{itemize}
    \end{itemize}
