...
\title{Software Quality Assurance (SQA) Report \\[0.7em] \large{27 Jun - 01 July 2016}\\[1.5em] 
       \huge{\texttt{INDIGO-DataCloud CDMI Server}}\\
}
...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE}\\[0.5em]\redbox{\strut \begin{huge}50\% done\end{huge}} 
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=50]{\textbf{\#2888} INDIGO-DataCloud CDMI Server SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/qos-codestyle/20}{qos-codestyle}.
...
\includegraphics[scale=0.5]{/srv/sqa-reports/build/figs/graph_qos-unittest.png}
\\
%\vspace{0.5em}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            \ganttbar[progress=0.0]{Packages (0.0/9.0)}{1}{3} \\
            \ganttbar[progress=0.0]{Files (0.0/42.0)}{1}{3} \\
            \ganttbar[progress=0.0]{Classes (0.0/43.0)}{1}{3} \\
            \ganttbar[progress=0.0]{Methods (0.0/353.0)}{1}{3} \\
            \ganttbar[progress=0.0]{Lines (0.0/2484.0)}{1}{3} \\
            \ganttbar[progress=0.0]{Conditionals (0.0/788.0)}{1}{3} \\
     [grid]
\end{ganttchart}
\end{center}

\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/qos-unittest/4}{qos-unittest}.
