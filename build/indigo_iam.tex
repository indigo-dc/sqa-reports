...
\title{Software Quality Assurance (SQA) Report \\[0.7em] \large{11 - 15 July 2016}\\[1.5em] 
       \huge{\texttt{INDIGO IAM (INDIGO Identity Access Management)}}\\
}
...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE}\\[0.5em]\redbox{\strut \begin{huge}82\% done\end{huge}} 
\end{center}
...
\begin{tabular}{ll}
    ...
    \hyperref[sec:unit_test]{Code coverage} & \graybox{45\%}\\ 
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=82]{\textbf{\#3248} INDIGO IAM SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#3254} Repository synchronization}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#3251} Code style specification}{1}{12} \\
            \ganttbar[
            progress=52,
            name=WBS1A
        ]{\textbf{\#3257} Unit testing coverage}{1}{12} \\
            \ganttbar[
            progress=90,
            name=WBS1A
        ]{\textbf{\#3260} Functional and integration testing coverage}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#3263} Configuration management}{1}{12} \\
            \ganttbar[
            progress=50,
            name=WBS1A
        ]{\textbf{\#3266} GitBook documentation}{1}{12} \\
     [grid]
\end{ganttchart}
