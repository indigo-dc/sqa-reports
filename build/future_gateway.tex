...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE}\\[0.5em]\redbox{\strut \begin{huge}55\% done\end{huge}} 
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=55]{\textbf{\#3809} FutureGateway API Server SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/fgapiserver-codestyle/2}{fgapiserver-codestyle}.

\subsection{Observations}
\begin{itemize}
        \item Team has proposed a code style standard but it is currently failing to comply with it.
    \end{itemize}
