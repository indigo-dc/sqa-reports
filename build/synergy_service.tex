...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=75]{\textbf{\#2996} Synergy Service SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/synergy-codestyle/10}{synergy-codestyle}.
...
\begin{enumerate}
        \item Enqueing of requests when no more resources are available (see File 01-test-queue.txt).
        \item Killing of VMs when the specified maximum time to live has been reached (see File 02-test-killing.txt).
        \item Fairshare projects with different shares specified for 2 projects (see File 03-test-fairshare.txt).
    \end{enumerate}
...
\subsection{Observations}
\begin{itemize}
        \item Points to improve in the documentation: \begin{itemize} \item Provide a more high-level (simpler, more understandable) description, its very hard to understand what synergy is, and what it actually does provide from the 	exttt{About Synergy} section. \item Highlight more clearly what are the capabilities and benefits that the product provides. \end{itemize}
    \end{itemize}
