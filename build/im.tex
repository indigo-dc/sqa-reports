...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\greenbox{\strut COMPLETE}\\[0.5em]\greenbox{\strut \begin{huge}95\% done\end{huge}} 
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=95]{\textbf{\#2963} IM SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/im-codestyle/79}{im-codestyle}.
...
\includegraphics[scale=0.5]{/srv/sqa-reports/build/figs/graph_im-unittest.png}
\\
%\vspace{0.5em}
...
\begin{ganttchart}[
    ...
    %\ganttgroup[progress=45]{Group 1}{1}{12} \\
            \ganttbar[progress=100.0]{Packages (6.0/6.0)}{1}{3} \\
            \ganttbar[progress=97.77778]{Files (44.0/45.0)}{1}{3} \\
            \ganttbar[progress=97.77778]{Classes (44.0/45.0)}{1}{3} \\
            \ganttbar[progress=65.888435]{Lines (6886.0/10451.0)}{1}{3} \\
...
\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/im-unittest/71}{im-unittest}.
