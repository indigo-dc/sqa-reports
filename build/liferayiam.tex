...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=47]{\textbf{\#4037} LiferayIAM SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\begin{itemize}
        \item Jenkins job is currently failing since there is no pom.xml available. Trying to address this situation with the developer.
        \item Setting progress to 50\% until the code style can be checked.
    \end{itemize}
