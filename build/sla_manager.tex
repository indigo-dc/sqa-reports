...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\redbox{\strut NOT COMPLETE}\\[0.5em]\redbox{\strut \begin{huge}0\% done\end{huge}} 
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=0]{\textbf{\#3194} SLA Manager SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=0,
            name=WBS1A
