...
\vspace{-3em}
\begin{center}
    \graybox{\strut SQA Progress Status}\greenbox{\strut COMPLETE}\\[0.5em]\greenbox{\strut \begin{huge}75\% done\end{huge}} 
\end{center}
...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=75]{\textbf{\#3065} java-syncrepos SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\href{https://jenkins.indigo-datacloud.eu:8080//job/syncrepos-codestyle/63}{syncrepos-codestyle}.
...
\begin{enumerate}
        \item Image listing.
        \item Image deletion.
        \item Image insertion from DockerHub.
        \item Automatic synchronization from a list of repositories.
    \end{enumerate}


\subsection{Observations}
\begin{itemize}
        \item Points to improve in the documentation: \begin{itemize} \item Please remove the sentence \textit{This project is a continuation of the discontinued https://github.com/indigo-dc/python-syncrepos} \item State where this component should be deployed (site) \item Describe the role within INDIGO architecture: what other components rely on it, etc. \item Describe how to install using packages from INDIGO repository and Docker deployment through indigodatacloud/reposync repository \item Separate the development guidelines in a specific section ? Development guide \item Document the API in a separate section \end{itemize}
    \end{itemize}


\input{templates/title_gitbook.tex}
\label{sec:gitbook}
Documentation available under \texttt{indigo-dc} GitBook organization: \vspace{0.1em} \begin{center}\url{https://indigo-dc.gitbooks.io/java-syncrepos/content/}\end{center} 
...
\subsection{Observations}
\begin{itemize}
        \item Pending OpenNebula configuration
    \end{itemize}
