...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=67]{\textbf{\#3434} indigo-omt SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
...
\begin{itemize}
        \item Currently searching for tools that check this standard.
        \item Progress set to 70\% since the team has adhered to a standard, provided in the code the checkstyle configuration, but the code is not currently being checked.
    \end{itemize}
