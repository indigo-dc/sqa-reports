...
\href{https://jenkins.indigo-datacloud.eu:8080//job/syncrepos-codestyle/43}{syncrepos-codestyle}.
...
\subsection{Build status}
    Last build status on Jenkins CI \href{https://jenkins.indigo-datacloud.eu:8080//job/syncrepos-unittest/41}{syncrepos-unittest}.
