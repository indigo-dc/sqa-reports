...
\begin{ganttchart}[
    ...
    \ganttgroup[progress=90]{\textbf{\#2906} rOCCI SQA FOR 1ST RELEASE}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#3938} Repository synchronization}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#2909} Code style specification}{1}{12} \\
            \ganttbar[
            progress=90,
            name=WBS1A
        ]{\textbf{\#2912} Unit testing coverage}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#2915} Functional and integration testing coverage}{1}{12} \\
            \ganttbar[
            progress=100,
            name=WBS1A
        ]{\textbf{\#2918} Configuration management}{1}{12} \\
            \ganttbar[
            progress=50,
            name=WBS1A
        ]{\textbf{\#2921} GitBook documentation}{1}{12} \\
     [grid]
\end{ganttchart}
...
\subsection{Observations}
\begin{itemize}
        \item Points to improve in the documentation: \begin{itemize} \item Remove the section \texttt{First chapter} has nothing \item Explain what rOCCI is and where does it fit in the INDIGO architecture, for what is it useful, who needs to deploy this and for what \item Describe the package installation using INDIGO repositories (both for Ubuntu 14.04 and CentOS7) \end{itemize}
    \end{itemize}
